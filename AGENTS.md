...
PHP demo app for Deepgram Text-to-Speech.
...
```
feat(php-text-to-speech): add diarization support
fix(php-text-to-speech): resolve WebSocket close handling
refactor(php-text-to-speech): simplify session endpoint
